...
export const DynamicMetadataEditor: React.FC<DynamicMetadataEditorProps> = ({
    ...
    const loadTypedMetadata = useTypedMetadataStore(state => state.loadTypedMetadata);
    ...
    useEffect(() => {
        const initialize = async () => {
            try {
                ...
                const existingMetadata = await loadTypedMetadata(resourceId, resourceType);
                if (existingMetadata) {
    ...
    const renderForm = () => {
        ...
        switch (resourceType) {
            ...
            case 'bibliography':
                return (
                    <Alert color="blue" title="Bibliography">
                        Bibliography entries have a dedicated editor. Use the Bibliography tab.
                    </Alert>
                );
            default:
                return (
